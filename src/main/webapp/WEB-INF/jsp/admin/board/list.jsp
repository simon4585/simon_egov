...
<div class="content-wrapper">
   ...
   <div class="content-header">
      ...
      <form name="frm" action ="<c:url value='/admin/board${prefix}/selectBoard.do'/>" method="get">
      ...
      <div class="card">
         ...
         <div class="card-body table-responsive p-0">
            <table class="table table-hover text-nowrap even_table">
               ...
               <tbody class="even_color">
                  <c:forEach items="${resultList}" var="result" varStatus="status">
                     <tr>
                        <td><b><c:out
                                 value="${paginationInfo.totalRecordCount+1 - ((searchVO.pageIndex-1) * searchVO.pageSize + status.count)}" /></b></td>
                        <td>
                           <form name="subForm" method="post"
                              action="<c:url value='/admin/board ${prefix}/viewBoard.do'/>">
                              <input type="hidden" name="bbsId"
                                 ...
                                 class="link" style="cursor: pointer;"><input
                                 type="submit"
                        ...
                        <td><span class="tag tag-success"> <c:out
                                 value="${result.frstRegisterPnttm}" />
                        </span></td>
                        <td><span class="badge badge-danger right"> <c:out
                                 value="${result.inqireCo}" />
                        </span></td>
                     </tr>
                  </c:forEach>
               </tbody>
